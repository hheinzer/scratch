...
// Allocate `num` elements of `size` bytes aligned to `align` (must be a power of 2; 0 uses a
...
// Resize a previous allocation to `num` elements of `size` bytes. If `align` is 0, the original
// align is preserved. If `ptr` is 0, behaves like `aligned_malloc`. If `num` is 0, frees `ptr` and
// returns 0.
